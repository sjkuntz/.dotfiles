  ...
  (setq-default
   ...
   '(
     ...
     (wakatime :variables
               ...
               wakatime-cli-path "/home/sk/anaconda3/bin/wakatime"
               wakatime-python-bin "/home/sk/anaconda3/bin/python")
     ;; zotero
     )
...
values."
  ;; This setq-defaults exp is an exhaustive list of all the supported
  ;; spacemacs settings.
  (setq-default
...
you should place your code here."
  ...
  (with-eval-after-load 'org
    ...
    (setq org-agenda-files (list "~/SYNC/Dropbox/org/agenda.org"))
